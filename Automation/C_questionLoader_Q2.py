...
current_workbook = '\\Jurassic_2_Compiled.xlsx'#'\\CompiledTEST.xlsx'#'\\PaLM_Compiled.xlsx'#'\\ChatGPT_Compiled.xlsx'#'\\Q2Test.xlsx'###'\\ObfuscationCategorization.xlsx''\\LM2.xlsx'
